...
LongUI.Window {
    ...
    background.color: LongUI.Theme.darkMode ? Qt.rgba(46 / 255, 46 / 255, 46 / 255, 1.0)
    ...
    LongUI.AboutDialog {
        ...
        description: qsTr("LongOS - calculator")
        iconSource: "image://icontheme/long-calculator"
    }
