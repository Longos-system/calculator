...
Item {
    ...
    GridLayout {
        ...
        StandardButton {
            icon: LongUI.Theme.darkMode ? "qrc:/images/dark/backspace.svg" : "qrc:/images/light/backspace.svg"
            onClicked: control.pressed("BACKSPACE")
        }
        StandardButton { text: "%"; onClicked: control.pressed(text) }
        StandardButton { text: "÷"; textColor: LongUI.Theme.highlightColor; onClicked: control.pressed(text) }
